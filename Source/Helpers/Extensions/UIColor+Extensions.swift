...
extension UIColor {
    ...
    static public var offWhiteOrBlack: UIColor {
        if #available(iOS 13, *) {
    ...
    static public var ypLabel: UIColor {
        if #available(iOS 13, *) {
            return .label
        }
        return .black
    ...
    static public var ypSecondaryLabel: UIColor {
        if #available(iOS 13, *) {
    ...
    static public var ypSecondarySystemBackground: UIColor {
        if #available(iOS 13, *) {
    ...
    static public var ypSystemBackground: UIColor {
        if #available(iOS 13, *) {
    ...
    static public var ypSystemBlue: UIColor {
        if #available(iOS 13, *) {
            return .systemBlue
        }
    ...
    static public var ypSystemGray: UIColor {
        if #available(iOS 13, *) {
            return .systemGray
        }
        return .gray
    ...
    static public var ypSystemRed: UIColor {
        if #available(iOS 13, *) {
            return .systemRed
        }
        return .red
